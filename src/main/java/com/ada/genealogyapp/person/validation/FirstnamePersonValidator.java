...
public class FirstnamePersonValidator extends Validator<Person> {
    ...
    public void check(Person person, ValidationResult result) {
        fieldValidationService.validate(FieldType.TREE_SHORT_TEXT_FIELD, person.getFirstname(), result);
