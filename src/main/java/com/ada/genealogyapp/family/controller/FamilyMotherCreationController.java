...
public class FamilyMotherCreationController {
    ...
    @PostMapping
    public ResponseEntity<?> createAndAddMotherToFamily(@PathVariable String treeId, @PathVariable String familyId, @RequestBody PersonRequest personRequest) throws ValidationException {
