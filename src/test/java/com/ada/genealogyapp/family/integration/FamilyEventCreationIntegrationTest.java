...
public class FamilyEventCreationIntegrationTest extends IntegrationTestConfig {
...
//        familyRepository.deleteAll();
    ...
    void shouldCreateFamilySuccessfully() throws Exception {
        ...
        eventRequest.setDate(LocalDate.of(2004, 4, 9));
        eventRequest.setDescription("Marriage");
        eventRequest.setPlace("Poland");


        mockMvc.perform(post("/api/v1/genealogy/tree/{treeId}/families/{familyId}/events", tree.getId(), family.getId())
